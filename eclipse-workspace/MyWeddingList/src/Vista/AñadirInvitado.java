...
public class AñadirInvitado extends JFrame {
	...
	public AñadirInvitado() {
		...
		comboBox_2.setModel(new DefaultComboBoxModel(new String[] {"INVITADO DE LA NOVIA", "INVITADO DEL NOVIO"}));
		...
		btnAadir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String nombre = lblNombreYApellido.getText();
				String autobus = (String) comboBox.getSelectedItem();
				String dieta = (String) comboBox_1.getSelectedItem();
				String tipo_invitado = (String) comboBox_2.getSelectedItem();
				new Controlador.Login1().insertUser(nombre, autobus, dieta, tipo_invitado, null);
			}
		});
